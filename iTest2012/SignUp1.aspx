...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="background-color: #FFFFFF; text-align: center;">
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <table align="center" style="border: medium ridge #008000; width: 700px; color: #003300;">
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: left">
                    ...
                    <asp:Label Font-Size="Small" ForeColor="Gray" ID="lblTen2" runat="server">Địa chỉ Email của bạn.</asp:Label>
                    <br />
                ...
                <td style="text-align: left" class="style4">
                    <asp:Label ID="Label1" runat="server" ForeColor="Blue">Bạn cần đọc và chấp nhận đồng ý theo Điều Khoản khi đăng ký</asp:Label><br />
            ...
            <tr>
                <td colspan="2" style="text-align: center">
                    ...
                    <br />
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/MasterPageContent/LogIn.aspx">Bạn đã có Tài khoản? Đăng nhập</asp:HyperLink>
                    <br />
                </td>
            </tr>
        </table>
